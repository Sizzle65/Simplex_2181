...
void MyRigidBody::AddToRenderList(void)
{
	...
	//m_pMeshMngr->AddWireSphereToRenderList(m_m4ToWorld * glm::translate(m_v3Center) * glm::scale(vector3(m_v3HalfWidth)), C_VIOLET, RENDER_WIRE);

	m_pMeshMngr->AddWireCubeToRenderList(m_m4ToWorld * glm::translate(m_v3Center) * glm::scale(vector3(m_v3HalfWidth * 2)), m_v3Color, RENDER_WIRE);
}
