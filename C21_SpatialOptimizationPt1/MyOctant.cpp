...
MyOctant::MyOctant(uint size,bool grid)
{
	Init();
	...
	m_pRigidBody->SetColorColliding(C_WHITE);
	m_iID = m_nCount;
	divisions = size;
	m_bgrid = grid;
	Subdivide();
...
MyOctant::MyOctant(vector3 a_v3Center, float a_fSize,uint size)
{
	Init();
	std::vector<vector3> v3MaxMin_list;
...
void MyOctant::Subdivide()
{
	...
	m_pChild[0] = new MyOctant(v3Center + vector3( fCenters, fCenters, fCenters), fSize, divisions);
	m_pChild[1] = new MyOctant(v3Center + vector3(-fCenters, fCenters, fCenters), fSize, divisions);
	m_pChild[2] = new MyOctant(v3Center + vector3(-fCenters,-fCenters, fCenters), fSize, divisions);
	m_pChild[3] = new MyOctant(v3Center + vector3( fCenters,-fCenters, fCenters), fSize, divisions);
	
	m_pChild[4] = new MyOctant(v3Center + vector3( fCenters, fCenters,-fCenters), fSize, divisions);
	m_pChild[5] = new MyOctant(v3Center + vector3(-fCenters, fCenters,-fCenters), fSize, divisions);
	m_pChild[6] = new MyOctant(v3Center + vector3(-fCenters,-fCenters,-fCenters), fSize, divisions);
	m_pChild[7] = new MyOctant(v3Center + vector3( fCenters,-fCenters,-fCenters), fSize, divisions);
